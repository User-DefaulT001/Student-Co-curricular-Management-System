...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add') {
        ...
        if (mysqli_query($conn, $sql)) {
            $_SESSION['success_message'] = "Club record added successfully!";
    ...
    if ($action === 'edit') {
        ...
        if (mysqli_query($conn, $sql)) {
            $_SESSION['success_message'] = "Club record updated!";
            header("Location: club_tracker.php"); exit();
        }
    }
}
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" placeholder="Search for clubs...">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                ...
                <button class="btn btn-primary btn-sm shadow-sm" data-toggle="modal" data-target="#addClubModal">
                    <i class="fas fa-plus fa-sm text-white-50"></i> Record New Membership
                </button>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3" style="background: var(--primary-gradient) !important;">
                    <h6 class="m-0 font-weight-bold text-white">My Club Activities</h6>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                while($row = mysqli_fetch_assoc($res)): ?>
                                    <tr>
                                        <td class="font-weight-bold"><?php echo htmlspecialchars($row['club_name']); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="?delete=<?php echo $row['club_id']; ?>" 
        ...
        <div class="modal-content border-0">
            <form method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group"><label>Date Joined</label><input type="date" name="join_date" class="form-control" required></div>
        ...
        <div class="modal-content border-0">
            <form method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group"><label>Date Joined</label><input type="date" name="join_date" id="e_date" class="form-control"></div>
                    <div class="form-group"><label>Status</label>
