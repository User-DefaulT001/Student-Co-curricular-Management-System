...
/**
 * Club Tracker Module
 * Strictly matched with Achievement, Merit, and Event Tracker UI
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add') {
        ...
        $sql = "INSERT INTO clubs (user_id, club_name, role, join_date, status) VALUES ('$user_id', '$name', '$role', '$date', '$status')";
        if (mysqli_query($conn, $sql)) $_SESSION['success_message'] = "Club record added!";
...
<div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-primary">
                        <h6 class="m-0 font-weight-bold text-white">My Membership History</h6>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="club_tracker.php?delete=<?php echo $row['club_id']; ?>" 
                                                   class="btn btn-danger btn-sm" onclick="return confirm('Delete this?')">
    ...
    </div> </div> <div class="modal fade" id="addClubModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST">
                <input type="hidden" name="action" value="add">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">Record New Membership</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group"><label>Position/Role</label><input type="text" name="role" class="form-control" required></div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group"><label>Club Name</label><input type="text" name="club_name" id="e_name" class="form-control" required></div>
                    <div class="form-group"><label>Position</label><input type="text" name="role" id="e_role" class="form-control" required></div>
                    <div class="form-group"><label>Join Date</label><input type="date" name="join_date" id="e_date" class="form-control" required></div>
                    <div class="form-group"><label>Status</label>
