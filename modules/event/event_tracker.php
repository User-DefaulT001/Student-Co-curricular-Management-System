                        ...
                        <?php if ($total_events > 0): ?>
                            <div class="sort-filter-section mb-4">
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <label for="sortOrder" class="form-label"><i class="fas fa-arrow-up-down"></i> Order:</label>
                                    ...
                                    <nav aria-label="Event page navigation">
                                        <ul class="pagination justify-content-center">
                                            <li class="page-item <?php echo $current_page <= 1 ? 'disabled' : ''; ?>">
                                                <a class="page-link" href="?page=<?php echo max(1, $current_page - 1); ?>&sort=<?php echo $sort_by; ?>&order=<?php echo strtolower($sort_order); ?>">Previous</a>
                                            </li>
                                            <?php for ($page = 1; $page <= $total_pages; $page++): ?>
                                                <li class="page-item <?php echo $page === $current_page ? 'active' : ''; ?>">
                                                    <a class="page-link" href="?page=<?php echo $page; ?>&sort=<?php echo $sort_by; ?>&order=<?php echo strtolower($sort_order); ?>"><?php echo $page; ?></a>
                                                </li>
                                            <?php endfor; ?>
                                            <li class="page-item <?php echo $current_page >= $total_pages ? 'disabled' : ''; ?>">
                                                <a class="page-link" href="?page=<?php echo min($total_pages, $current_page + 1); ?>&sort=<?php echo $sort_by; ?>&order=<?php echo strtolower($sort_order); ?>">Next</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
